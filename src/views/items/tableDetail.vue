    ...
    <div>
        <Row>
            ...
            <Card>
                    ...
                    <Page :class-name='pageClass' :total="total" :page-size='pageSize' :current='currentPage'
                        show-sizer show-elevator show-total @on-change="changepage" @on-page-size-change="changepageSize" />
            

                <Modal v-model="modal1" title="删除" @on-ok="delteok" @on-cancel="deletecancel">
                    <p>确定删除该项数据？</p>
